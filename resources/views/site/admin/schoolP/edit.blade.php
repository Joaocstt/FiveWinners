...
{{--            @endif--}}
            <div class="card">
                <div class="card-body p-4">
                    <h5 class="card-title">Você está editando o aluno: {{$user->name}}</h5>
                    <hr/>
                    <div class="form-body">
                        <div class="row">
                            <div class="col-lg-8">
                                <div class="card-body p-4">
                                    <form class="row g-3" method="POST" action="{{route('admin.sebastiao-pedrosa.update', $user->id)}}">
                                        @csrf
                                        @method('PUT')
                                        <div class="col-md-12">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <select class="form-select" id="school" name="school">
                                                    <option selected value="2">Sebastião Pedrosa</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="score" name="score" placeholder="0" value="{{$points->scores}}">
                                                @endforeach
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                            ...
                            <div class="col-lg-4">
                                <img width="570px" src="{{asset('assets/images/undraw_My_personal_files_re_3q0p.png')}}">
                            </div>
                        </div><!--end row-->
                    </div>
                </div>
