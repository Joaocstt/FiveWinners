    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                ...
                <div class="ms-auto">
                    <div class="btn-group">
                        <a href="{{route('admin.sebastiao-pedrosa.users')}}" class="btn btn-primary px-4">Voltar</a>
                    </div>
                </div>
            </div>
            <!--end breadcrumb-->
                    ...
                    <div class="form-body">
                            <div class="col-lg-8">
                                <div class="card-body p-1">
                                    <form class="row g-3" method="POST" action="{{route('admin.sebastiao-pedrosa.destroy', $user->id)}}">
                                        @csrf
                                        @method('delete')
                                        <div class="col-md-10">
